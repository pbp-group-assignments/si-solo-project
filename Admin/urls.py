...
from Admin.views import set_ditolak_pelaku_usaha, list_pendaftaran_pelaku_usaha_ditolak, tambah_wisata
...
urlpatterns = [
    ...
    path('tambah-wisata', tambah_wisata, name='tambah_wisata'),
]